...
link_en() {
  ...
  "${target}/pc-edgenode-service" command link --bulklink --region "$region" --systemKey "$system_key" --appVersion="2025-06-30-0424" --edgenodeUpdaterPath="./pc-edgenode-updater"
}
